...
const TASK_TYPE_LABELS: Record<string, string> = {
  ...
  [TASK_TYPE.VIDEO_COMPOSE]: 'progress.taskType.videoCompose',
...
const STAGE_LABELS: Record<string, string> = {
  ...
  compose_prepare: 'progress.stage.composePrepare',
  compose_render: 'progress.stage.composeRender',
  compose_upload: 'progress.stage.composeUpload',
  compose_persist: 'progress.stage.composePersist',
